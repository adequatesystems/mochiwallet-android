...
| **Android SDK** | API 34 | `C:\Android\cmdline-tools\latest\bin\sdkmanager.bat "platform-tools" "platforms;android-34" "build-tools;34.0.0"` |
...
The build scripts automatically apply patches to hide UI elements that don't work in Android WebView:

| Patch | What It Hides |
|-------|---------------|
| `android-ui.css` | Widens layout for mobile screens |
| `hide-sidebar-button.js` | Panel toggle button in header (opens browser panel - N/A in WebView) |
| `hide-mcm-import.js` | "Import MCM File" option (file system APIs unavailable) |
| `hide-export-wallet.js` | Backup section in Settings (file download APIs unavailable) |
...
- **Location**: `/data/data/com.mochimo.wallet/` (Android app sandbox)
